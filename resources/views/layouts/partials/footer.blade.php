<footer class="bg-gray-800 text-white py-8">
    <div class="container mx-auto px-6">
        <div class="flex flex-wrap justify-between">
            ...
            <div class="w-full lg:w-3/4 flex flex-wrap justify-between">
                <div class="w-full sm:w-1/2 md:w-1/3 mb-6 sm:mb-0 px-4">
                    <h4 class="font-semibold mb-2">Navigation</h4>
                    <ul>
                        <li><a href="{{ route('welcome') }}" class="text-gray-400 hover:text-white">Accueil</a></li>
                        <li><a href="{{ route('covoiturage') }}" class="text-gray-400 hover:text-white">Covoiturage</a></li>
