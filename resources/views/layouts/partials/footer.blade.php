    ...
    <div class="bg-gray-800 text-white py-8">
        <div class="container mx-auto px-6">
            <div class="flex flex-wrap justify-between items-start">
                ...
                <div class="w-full lg:w-auto grid grid-cols-1 xs:grid-cols-2 md:flex md:flex-wrap justify-between gap-8">
                    ...
                    <div class="w-full sm:w-auto mb-6 sm:mb-0">
                        <h4 class="font-semibold mb-2">Contactez-nous</h4>
                        <ul>
                            <li><a href="mailto:contact@studi.fr" class="text-gray-400 hover:text-white">contact@studi.fr</a></li>
                            <li><a href="tel:+33174888555" class="text-gray-400 hover:text-white">+33(0)1 74 888 555</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="w-full sm:w-auto">
                        ...
                        <div class="flex space-x-4">
                            <a href="https://x.com/EcoleStudi"
                                class="text-gray-400 hover:text-white transform hover:scale-110 hover:shadow-lg transition duration-300 ease-in-out">
                            ...
                            <a href="https://www.facebook.com/EcoleStudi/?locale=fr_FR"
                            ...
                            <a href="https://www.instagram.com/ecole_studi/?hl=fr"
                                class="text-gray-400 hover:text-white transform hover:scale-110 hover:shadow-lg transition duration-300 ease-in-out"><svg
                                    class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path
