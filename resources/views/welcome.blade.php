        ...
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 max-w-4xl mx-auto">
                <form action="#" method="GET"
                    class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-10 gap-4 items-end">
                    ...
                    <div class="lg:col-span-1">
                        ...
                        <input type="number" id="seats" name="seats" min="1" max="8"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            placeholder="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                    </div>

                    <!-- btn recherche -->
                    <div class="lg:col-span-1">
                        <button type="submit"
                            class="w-full bg-green-600 text-white font-bold py-2 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
